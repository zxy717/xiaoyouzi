...
class Network(object):
    ...
    def load(self, data_path, session, ignore_missing=False):
        data_dict = np.load(data_path).item()
        for key in ['conv1_1','conv1_2','conv2_1','conv2_2','conv3_1','conv3_2','conv3_3','conv4_1','conv4_2','conv4_3']:
        # for key in ['conv1', 'bn_conv1', 'res2a_branch1', 'bn2a_branch1', 'res2a_branch2a', 'bn2a_branch2a', 'res2a_branch2b', 'bn2a_branch2b',
        #                 'res2a_branch2c', 'bn2a_branch2c','res2b_branch2a','bn2b_branch2a','res2b_branch2b','bn2b_branch2b','res2b_branch2c','bn2b_branch2c','res2c_branch2a',
        #             'bn2c_branch2a','res2c_branch2b','bn2c_branch2b','res2c_branch2c','bn2c_branch2c','res3a_branch1','bn3a_branch1','res3a_branch2a','bn3a_branch2a',
        #             'res3a_branch2b','bn3a_branch2b','res3a_branch2c','bn3a_branch2c','res3b_branch2a','bn3b_branch2a','res3b_branch2b','bn3b_branch2b','res3b_branch2c',
        #             'bn3b_branch2c','res3c_branch2a','bn3c_branch2a','res3c_branch2b','bn3c_branch2b','res3c_branch2c','bn3c_branch2c','res3d_branch2a','bn3d_branch2a','res3d_branch2b',
        #             'bn3d_branch2b','res3d_branch2c','bn3d_branch2c']:
            with tf.variable_scope(key, reuse=True):
                for subkey in data_dict[key]:
                    try:
                        var = tf.get_variable(subkey)
    ...
    def proposal_target_layer(self, input, classes, name):
        ...
        with tf.variable_scope(name) as scope:
            ...
            #bbox_targets_2 = tf.convert_to_tensor(bbox_targets_2, name='bbox_targets_2')  # goes to FRCNN loss
            #bbox_inside_weights_2 = tf.convert_to_tensor(bbox_inside_weights_2, name='bbox_inside_weights_2')
            #bbox_outside_weights_2 = tf.convert_to_tensor(bbox_outside_weights_2, name='bbox_outside_weights_2')
    ...
    def build_loss(self, ohem=False):
        ...
        #####bounding box regression Ln loss
        #smooth = 0.99
        #bbox_targets_2 = self.get_output('roi-data')[5]
        #bbox_inside_weights_2 = self.get_output('roi-data')[6]
        #bbox_outside_weights_2 = self.get_output('roi-data')[7]

        #y_true_tensor = (bbox_inside_weights_2 * bbox_targets_2)[..., 4:]
        #y_pred_tensor = (bbox_inside_weights_2 * bbox_pred)[..., 4:]

        #repulse = creat_repulsion(y_true_tensor,y_pred_tensor,smooth)

        #loss_rep_n = tf.reduce_sum(repulse,axis=[1])
        #repulsion_loss = tf.reduce_mean(loss_rep_n)


        loss = cross_entropy + loss_box + rpn_cross_entropy + rpn_loss_box
        #loss = cross_entropy + loss_box + rpn_cross_entropy + rpn_loss_box + repulsion_loss
        ...
        #return loss, cross_entropy, loss_box, rpn_cross_entropy, rpn_loss_box, repulsion_loss