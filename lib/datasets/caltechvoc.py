...
class caltechvoc(imdb):
    def __init__(self, image_set, data_path=None):
        ...
        #                     else devkit_path
        self._data_path = '/media/zxy/000EEF4500087057/ubuntuDATA/2projects/TFFRCNN/data/caltechvoc2/'
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            x2 = min(float(bbox.find('xmax').text) - 1,640)
            y2 = min(float(bbox.find('ymax').text) - 1,480)
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._data_path, 'results', 'caltech', 'Main')
